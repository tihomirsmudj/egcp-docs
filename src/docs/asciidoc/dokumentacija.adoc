...
Context diagram kao prijedlog idejnog rješenja +
...
[.thumb]
image::Jenkins-confgure-docker.jpg[scaledwidth=75%,align="center"]
...
Openshit konzola dostupna je na: https://bdxlb12.mbu.local:8443/console/
